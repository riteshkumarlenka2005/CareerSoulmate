...
const CollegesPage: React.FC<{ onNavigate: (page: any) => void }> = ({ onNavigate }) => {
  ...
  }, [search, selectedState, selectedType, selectedFacility, selectedMedium]);
          ...
          <div className="max-w-6xl mx-auto bg-white/[0.03] border border-white/10 rounded-[48px] p-10 backdrop-blur-3xl shadow-2xl relative">
            ...
            <div className="mt-8 flex justify-center gap-6">
               ...
               <div className="w-full flex items-end">
                  <button className="w-full bg-blue-600 hover:bg-blue-500 text-white py-3.5 rounded-xl font-black uppercase tracking-widest text-[10px] transition-all shadow-xl shadow-blue-600/20 active:scale-95">
                    Launch Advanced Map
                  </button>
               </div>
            </div>
            ...
            >
              ...
              <div className="p-12 flex-grow flex flex-col">
                <div className="mb-6 space-y-1">
                  ...
                  <p className="text-[9px] text-gray-500 font-bold uppercase tracking-widest">{college.location}</p>
                </div>
