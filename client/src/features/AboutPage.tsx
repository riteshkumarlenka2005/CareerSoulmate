...
const AboutPage: React.FC<AboutPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-[#050505] text-white overflow-hidden animate-in fade-in duration-700">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="inline-block px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] font-black tracking-widest uppercase backdrop-blur-md animate-pulse">
            ...
            <div className="flex flex-wrap gap-6 pt-4">
               <div className="flex items-center gap-3">
                  ...
                  <span className="text-[9px] font-black text-blue-500 uppercase tracking-[0.3em]">Decision Authority</span>
               </div>
               <div className="flex items-center gap-3">
                  <div className="w-12 h-px bg-gradient-to-r from-cyan-500 to-transparent" />
                  <span className="text-[9px] font-black text-cyan-500 uppercase tracking-[0.3em]">Neural Matching</span>
               </div>
               <div className="flex items-center gap-3">
                  <div className="w-12 h-px bg-gradient-to-r from-indigo-500 to-transparent" />
                  <span className="text-[9px] font-black text-indigo-500 uppercase tracking-[0.3em]">Explainable AI</span>
               </div>
            </div>
          </div>
      ...
      <section className="py-32 px-6 border-y border-white/5 relative bg-[#060606]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24">
          <div className="space-y-12">
            <div>
              <h3 className="text-[10px] font-black tracking-[0.5em] text-blue-500 uppercase mb-4">The Crisis We Solve</h3>
            ...
            <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="group p-8 rounded-[32px] bg-white/[0.01] border border-white/5 hover:border-blue-500/20 transition-all duration-500">
          ...
          <div className="flex flex-col justify-center">
             <div className="p-12 md:p-16 rounded-[60px] bg-gradient-to-br from-blue-600/10 via-transparent to-transparent border border-white/10 relative overflow-hidden shadow-2xl">
                ...
                <h3 className="text-[10px] font-black tracking-[0.5em] text-blue-500 uppercase mb-4">Our Mission</h3>
                ...
                <div className="grid grid-cols-2 gap-8 py-8 border-t border-white/5">
                  <div>
                    ...
                    <p className="text-[9px] text-gray-500 uppercase font-black tracking-widest">Institutions Mapped</p>
                  </div>
                  <div>
                    <h5 className="text-white font-black text-2xl mb-1">500+</h5>
                    <p className="text-[9px] text-gray-500 uppercase font-black tracking-widest">Skill Clusters</p>
                  </div>
                </div>
             </div>
          </div>
      ...
      <section className="py-32 px-6 bg-[#030303] overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-gray-500 text-xs font-black uppercase tracking-[0.5em]">The Engineering Behind the Guidance</p>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="flex flex-col gap-6 relative z-10">
              {[
                ...
                <div key={i} className={`p-8 rounded-[32px] border ${layer.color} backdrop-blur-xl group hover:-translate-y-1 transition-all duration-500`}>
                  <div className="flex justify-between items-center">
                    <div className="flex gap-6 items-center">
                      <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[10px] font-black text-white group-hover:bg-blue-600 transition-colors">0{i+1}</div>
                      <div>
                        <h4 className="text-white font-black uppercase tracking-widest text-sm mb-1">{layer.title}</h4>
                        <p className="text-gray-400 text-[10px] font-bold uppercase tracking-wide">{layer.desc}</p>
                      </div>
                    </div>
      ...
      <section className="py-32 px-6 border-y border-white/5">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <h3 className="text-[10px] font-black tracking-[0.5em] text-blue-500 uppercase mb-4">Intelligence Engine</h3>
            ...
            <ul className="space-y-4">
              {["Skill Demand Prediction (6-24 Months)", "Regional Salary Benchmarking", "Institutional Performance Grading", "NSQF Competency Mapping"].map((item, i) => (
                <li key={i} className="flex items-center gap-3">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest text-gray-500">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          
          <div className="relative group p-10 rounded-[50px] bg-white/[0.01] border border-white/5 overflow-hidden">
             <div className="space-y-8">
                  ...
                  {[40, 70, 45, 90, 60, 80, 50].map((h, i) => (
                    <div key={i} className="flex-grow bg-blue-600/20 relative group/bar">
                       <div 
                         ...
                         style={{ height: `${h}%` }} 
                       />
                       <div className="absolute -top-6 left-1/2 -translate-x-1/2 opacity-0 group-hover/bar:opacity-100 transition-opacity text-[8px] font-black text-white">{h}%</div>
                    </div>
                  ))}
               </div>
               ...
               <div className="text-center pt-4">
                  <p className="text-[10px] font-black uppercase text-blue-500/60 tracking-[0.3em]">Projected Market Growth 2025-2027</p>
               </div>
             </div>
          </div>
        </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-gray-500 text-xs font-black uppercase tracking-[0.5em]">Built for National Readiness</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-[32px] bg-white/[0.02] border border-white/5 hover:border-blue-500/20 transition-all text-center">
                 ...
                 <p className="text-gray-500 text-[10px] font-bold uppercase leading-relaxed">{badge.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 px-6 bg-[#030303] border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-gray-500 text-xs font-black uppercase tracking-[0.5em]">The Architects of Professional Destiny</p>
          </div>

          <div className="grid md:grid-cols-3 gap-10">
            {team.map((member, i) => (
              <div key={i} className="group p-10 rounded-[48px] bg-white/[0.01] border border-white/5 hover:border-blue-500/30 transition-all relative overflow-hidden">
                ...
                <p className="text-blue-500 font-black uppercase tracking-widest text-[10px] mb-8">{member.role}</p>
                <p className="text-gray-500 text-xs font-medium leading-relaxed mb-10 min-h-[80px]">{member.desc}</p>
                
                <div className="flex flex-wrap gap-2">
                   {member.skills.map((skill, si) => (
                     <span key={si} className="px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 text-[9px] font-black text-gray-500 uppercase tracking-widest">
                       {skill}
                     </span>
                   ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {[
              ...
              <div key={i}>
                <h5 className="text-blue-500 text-[10px] font-black uppercase tracking-[0.4em] mb-3">{s.category}</h5>
      ...
      {/* 8. FUTURE ROADMAP */}
      <section className="py-32 px-6 relative bg-[#080808] border-y border-white/5">
        <div className="max-w-7xl mx-auto">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
               {roadmap.map((item, i) => (
                 <div key={i} className="relative z-10 text-center group">
                    ...
                    <h5 className="text-blue-500 font-black uppercase tracking-widest text-[10px] mb-3">{item.phase}</h5>
                    <h4 className="text-white font-black uppercase tracking-wide text-sm mb-4 leading-tight">{item.title}</h4>
                    <p className="text-gray-500 text-[10px] font-bold uppercase leading-relaxed px-6">{item.desc}</p>
                 </div>
               ))}
             </div>
          </div>
