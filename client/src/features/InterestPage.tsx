      ...
      {view === 'intro' && (
        <section className="relative pt-20 pb-10 px-4 md:pt-28 md:pb-16 md:px-6 overflow-visible">
          <div className="absolute inset-0 z-0">
            <div className="absolute top-0 right-1/4 w-[250px] h-[250px] md:w-[400px] md:h-[400px] lg:w-[600px] lg:h-[600px] bg-purple-600/5 blur-[180px] rounded-full" />
          </div>

          <div className="max-w-full px-2 md:max-w-4xl md:px-0 mx-auto relative z-10 text-center">
            <div className="inline-block px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-black tracking-widest uppercase mb-6 md:mb-8 lg:mb-10">
        ...
        <section className="py-10 px-4 md:py-20 md:px-6 max-w-7xl mx-auto animate-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             {INTEREST_DIMENSIONS.map((dim) => (
               <div 
                 key={dim.id} 
                 className="group p-5 md:p-8 lg:p-10 rounded-3xl bg-white/[0.04] border border-white/10 hover:border-purple-500/40 transition-all duration-500 flex flex-col h-full relative overflow-hidden"
               >
                  <div className={`absolute -top-5 md:p-8 lg:p-10 -right-10 w-32 h-32 blur-[80px] opacity-20 bg-${dim.color}-500 transition-all group-hover:opacity-40`} />
                  ...
                  <div className="mt-auto pt-4 md:pt-6 md:pt-8 lg:pt-10">
                     <button 
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {QUESTIONS[currentQuestionIdx].options.map((opt, i) => (
                      <button 
                        ...
                        className="group relative p-5 md:p-8 lg:p-12 rounded-3xl bg-white/[0.04] border border-white/10 hover:border-purple-500 hover:bg-purple-600/5 transition-all duration-500 flex flex-col items-center justify-center min-h-[280px]"
                      >
        ...
        <section className="py-10 px-4 md:py-20 md:px-6 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-1000">
           ...
           <div className="grid lg:grid-cols-2 gap-8 md:gap-14 lg:gap-20 items-center mb-32">
              <div className="space-y-12">
                 <div>
                    <h3 className="text-3xl font-black uppercase tracking-tight mb-6 md:mb-8 lg:mb-10">Interest <span className="text-purple-500">Hierarchy.</span></h3>
              ...
              <div className="relative">
                 ...
                 <div className="relative p-5 md:p-8 lg:p-12 rounded-3xl border border-white/10 bg-[#080808] backdrop-blur-3xl shadow-2xl">
                    <h4 className="text-xs font-black text-purple-500 uppercase tracking-[0.4em] mb-6 md:mb-8 lg:mb-10">Matching Career Clusters</h4>
                    <div className="space-y-10">
