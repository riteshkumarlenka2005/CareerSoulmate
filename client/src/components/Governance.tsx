        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {badges.map((b, i) => (
            <div key={i} className="flex flex-col items-center text-center group">
              ...
              <h4 className="text-white font-black uppercase tracking-[0.2em] text-xs mb-2">{b.label}</h4>
              <p className="text-gray-300 text-xs font-bold leading-tight uppercase">{b.desc}</p>
            </div>
          ))}
        </div>
      </div>
