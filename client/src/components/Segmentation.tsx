    ...
    <section className="py-24 bg-[#080808] relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.4em]">Integrated Career Ecosystem</p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {personas.map((p, i) => (
            <div key={i} className="group p-8 rounded-[32px] bg-white/[0.02] border border-white/5 hover:bg-blue-600 transition-all duration-500 cursor-pointer text-center flex flex-col items-center">
              ...
              <p className="text-gray-500 text-[10px] font-bold leading-tight uppercase group-hover:text-blue-100 transition-colors">{p.desc}</p>
            </div>
          ))}
        </div>
      </div>
