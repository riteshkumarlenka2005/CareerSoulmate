    ...
    <section className="py-24 bg-[#080808] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="relative order-2 lg:order-1">
          ...
          <div className="relative aspect-square bg-[#050505] rounded-3xl border border-white/5 p-8 overflow-hidden shadow-2xl flex items-center justify-center">
             ...
             <div className="absolute top-10 right-10 bg-black/80 backdrop-blur-md border border-white/10 p-4 rounded-xl max-w-[150px] animate-in slide-in-from-right-2">
                <p className="text-[10px] font-black text-blue-500 uppercase mb-1">State Focus</p>
        ...
        <div className="order-1 lg:order-2">
          ...
          <div className="grid grid-cols-2 gap-6 mb-10">
            <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02]">
              ...
              <p className="text-gray-500 text-[10px] font-bold uppercase leading-tight">Unified scholarship portal integration</p>
            </div>
            <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02]">
              <h5 className="text-white font-black uppercase tracking-widest text-xs mb-1">Central Schemes</h5>
              <p className="text-gray-500 text-[10px] font-bold uppercase leading-tight">Direct mapping to NSP & specialized grants</p>
            </div>
          </div>

          <button className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-black uppercase tracking-[0.2em] text-[10px] transition-all">
