...
const IntelligenceLoop: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-[#080808] relative overflow-hidden border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-500 text-xs font-black uppercase tracking-[0.4em]">Our Core Operating Logic</p>
        </div>
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 w-full relative z-10">
            {steps.map((step, i) => (
              <div key={i} className="relative group text-center p-6 rounded-2xl border border-white/5 bg-white/[0.02] hover:border-blue-500/50 transition-all duration-300">
                ...
                <p className="text-[10px] text-gray-500 font-bold leading-tight uppercase">{step.desc}</p>
